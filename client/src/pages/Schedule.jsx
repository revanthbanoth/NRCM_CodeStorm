...
import { Coffee, Zap, Info, Play, CheckCircle, Code, Award, Music, Moon, Gamepad2, Users } from 'lucide-react';
        ...
        <div className="pt-24 pb-20 px-6 max-w-5xl mx-auto">
            ...
            >
                ...
                <p className="max-w-2xl mx-auto text-gray-400 text-lg">
                    A detailed timeline of activities, mentoring sessions, and breaks.
                </p>
            </motion.div>
                                    ...
                                    <div className={`glass-card p-5 group hover:border-blue-500/30 transition-all flex flex-col md:flex-row md:items-center gap-4 ${item.type === 'highlight' ? 'border-blue-500/30 bg-blue-500/5' : ''
                                        ...
                                        <div className="flex-1">
                                            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-1">
                                                ...
                                                <span className="text-sm font-mono text-gray-500 bg-black/30 px-3 py-1 rounded-full border border-gray-800/50 whitespace-nowrap">
                                                    {item.time}
                                                </span>
                                            </div>
                                        </div>
